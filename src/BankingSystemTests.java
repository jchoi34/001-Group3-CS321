...
public class BankingSystemTests {
	...
	public static void failFmt(String fmt, Object... args){
	  ...
	  @SuppressWarnings("unchecked")
	  @org.junit.Test(timeout=1000) public void BankingSystemTest21(){
	  // Check LinkedArrayNode.remove(x) where x is null throws exception
	  String[] args = {"James", "MasterCard", "1/2019", "379088125417814"};
	  BankingSystem bank = new BankingSystem();
	  CheckIn checkIn = new CheckIn(args);
	  ...
	  @SuppressWarnings("unchecked")
	  @org.junit.Test(timeout=1000) public void BankingSystemTest22(){
	  // Check LinkedArrayNode.remove(x) where x is null throws exception
	  String[] args = {"", "James", "MasterCard", "1/2019", "379088125417814"};
	  CheckIn checkIn = new CheckIn(args);
	  ...
	  @SuppressWarnings("unchecked")
	  @org.junit.Test(timeout=1000) public void BankingSystemTest23(){
	  // Check LinkedArrayNode.remove(x) where x is null throws exception
	  String[] args = {"", "Jjon", "MasterCard", "1/2019", "1111111111111"};
	  CheckIn checkIn = new CheckIn(args);
